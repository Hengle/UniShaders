...
Shader "UniShaders/Toony/Grass" {
    Properties {
        ...
        _SpeedMultipler ("SpeedMultipler", Float ) = 1.2
        _BlendInfluence ("BlendInfluence", Range(0, 1)) = 1
